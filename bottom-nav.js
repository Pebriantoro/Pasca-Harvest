/* =====================================================================
   ...
   Cuma satu tombol: Menu (buka sidebar lama). Fitur shortcut custom
   (3 menu tersering + pengaturan "Menu Ngambang") dicabut atas
   permintaan — kompleksitasnya (usage tracking, picker modal, dll)
   ga sepadan buat satu tombol doang.
   ===================================================================== */
(function(){
  function buildBar(){
